  ...
  return (
    ...
    >
      ...
      <aside
        ...
        className="order-2 min-h-0 h-full lg:order-1 lg:sticky lg:top-0 lg:h-full lg:max-h-full"
      >
        <div className="flex h-full flex-row gap-2 overflow-x-auto rounded-3xl border border-white/10 bg-zinc-950 p-2 lg:flex-col lg:overflow-visible">
...
<section className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-[#0b0b0d] p-0">
        ...
        {/* EDITABLE SURFACES */}
        <div className="flex shrink-0 items-center justify-center gap-1 overflow-x-auto border-b border-white/[0.06] bg-zinc-950/80 px-3 py-2 backdrop-blur-xl">
          {(
            [
              ["front", "FRONT"],
              ["insideFront", "INSIDE FRONT"],
      ...
      {/* EDITOR */}
      <section
        className={`order-2 min-h-0 min-w-0 overflow-y-auto border-l border-white/10 bg-zinc-950 lg:order-3 ${
    isEditorFullscreen
