      ...
      <main className="min-h-screen bg-[var(--mn-bg)] text-[var(--mn-text)]">
        <section className="border-b border-[var(--mn-border)]">
          <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-[var(--mn-text-muted)] md:text-lg">
              Discover premium MineNote designs crafted for students,
              creators and dreamers.
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <div className="rounded-full border border-[var(--mn-border-strong)] px-5 py-2">
