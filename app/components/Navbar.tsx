      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.08] bg-black/90 backdrop-blur-2xl">
        <nav aria-label="Main navigation">
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            {/* MOBILE */}
            <div className="relative h-[64px] md:hidden">
      ...
      {menuOpen && (
        <>
          ...
          <div
            ...
            className="fixed left-0 right-0 top-[64px] z-[60] overflow-hidden rounded-b-3xl border-x border-b border-white/[0.10] bg-zinc-950/98 shadow-2xl shadow-black/70 md:hidden"
          >
            <div className="mx-auto max-w-7xl px-6">
