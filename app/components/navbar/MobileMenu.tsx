        ...
        <nav aria-label="Mobile navigation" className="space-y-0.5">
          ...
          {navItems.map(([href, label]) => (
            <Link
              ...
              href={href}
              onClick={closeMenu}
              className="group flex min-h-[48px] items-center justify-between rounded-xl px-4 text-[14px] font-medium text-zinc-300 transition-all duration-150 hover:bg-white/[0.04] hover:text-yellow-400 active:bg-white/[0.06]"
            >
              <span>{label}</span>
